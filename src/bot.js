...
bot.onText(/\/start/, (msg) => {
  ...
  const welcomeMessage = `😇 **Hello**, ${name}!\n\n`
    + '**🌟 I am a bot to  Short Your Links Directly to your indiaearnx.com Account**\n\n'
    + '**💠 You can find your api key on https://indiaearnx.com/member/tools/api**\n\n' 
    + '**Example: /setapi c49399f21fc020161bc2a31475ec59f35ae5b4**\n\n'
